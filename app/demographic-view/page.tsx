...
// // Assuming the path to your UI components and API/Types are correct
// import { Navbar } from "../../src/components/ui/navbar";
// import { CardMetric } from "../../src/components/ui/card-metric";
// import { Footer } from "../../src/components/ui/footer";
// import { BarChartComponent } from "../../src/components/ui/BarChartComponent"; // NEW
// import { PerformanceTable } from "../../src/components/ui/PerformanceTable"; // NEW
// import { fetchDemographicData } from "../../src/lib/api"; // NEW API call
// import { DemographicData } from "../../src/types/marketing"; // NEW Types
...
//   // Ensuring it matches the style used in the original page.tsx
...
//   // Data Loading Hook (Same pattern as page.tsx)
//   useEffect(() => {
//     const loadData = async () => {
//       try {
//         const data = await fetchDemographicData(); // Call the new aggregation function
//         setDemographicData(data);
//       } catch (err) {
//         setError(
//           err instanceof Error ? err.message : "Failed to load demographic data"
//         );
...
//     // ... (Error and Loading state logic is similar to your page.tsx) ...
//     if (error) {
//       return (
...
//           Detailed performance breakdown by Gender and Age Group.
//         </p>
//       </>
//     );
//   };
...
//             <div className="text-center">{renderHeroContent()}</div>
//           </div>
//         </section>
...
//           {demographicData && (
//             <>
//               {/* --- 1. Key Gender Metrics Cards (6 Cards in a 3-column grid) --- */}
...
//                   value={demographicData.male.total_clicks.toLocaleString()}
//                   icon={<MousePointerClick className="h-5 w-5" />}
//                   className="text-blue-400"
//                 />
//                 <CardMetric
//                   title="Total Spend (Male)"
//                   value={formatCurrency(demographicData.male.total_spend)}
//                   icon={<DollarSign className="h-5 w-5" />}
//                   className="text-red-400"
//                 />
//                 <CardMetric
//                   title="Total Revenue (Male)"
//                   value={formatCurrency(demographicData.male.total_revenue)}
...
//                   value={demographicData.female.total_clicks.toLocaleString()}
//                   icon={<MousePointerClick className="h-5 w-5" />}
//                   className="text-pink-400"
//                 />
//                 <CardMetric
//                   title="Total Spend (Female)"
//                   value={formatCurrency(demographicData.female.total_spend)}
//                   icon={<DollarSign className="h-5 w-5" />}
//                   className="text-red-400"
//                 />
//                 <CardMetric
//                   title="Total Revenue (Female)"
//                   value={formatCurrency(demographicData.female.total_revenue)}
//                   icon={<TrendingUp className="h-5 w-5" />}
//                   className="text-green-400"
//                 />
//               </div>

//               {/* --- 2. Bar Graphs by Age Group (2 Charts in a 2-column grid) --- */}
//               <h2 className="text-xl font-semibold text-white mb-4">
//                 Performance by Age Group Visualizations
//               </h2>
//               <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-8">
//                 <BarChartComponent
//                   title="Total Spend by Age Group"
//                   data={demographicData.spendByAgeGroup}
//                   dataKey="spend"
//                   tooltipKey="Spend"
//                 />
//                 <BarChartComponent
...
//               {/* --- 3. Performance Tables (2 Tables in a 2-column grid) --- */}
//               <h2 className="text-xl font-semibold text-white mb-4">
...
//                   data={demographicData.malePerformanceTable}
//                 />
//                 <PerformanceTable
//                   title="Campaign Performance by Female Age Groups"
//                   data={demographicData.femalePerformanceTable}
//                 />
//               </div>
//             </>
//           )}
